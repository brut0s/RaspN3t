...
print bcolors.WARNING + "\nThis Configuration Will turn your Raspberry-Pi into a Ethernet to Tor Router" + bcolors.ENDC
...
#print bcolors.WARNING + "\n[!]. Flushing Wireless Connections" + bcolors.ENDC
...
os.system('sudo iptables -t nat -A PREROUTING -i  ' + outlet + ' -p tcp --dport 22 -j REDIRECT --to-ports 22')
os.system('sudo iptables -t nat -A PREROUTING -i  ' + outlet + ' -p udp --dport 53 -j REDIRECT --to-ports 53')
os.system('sudo iptables -t nat -A PREROUTING -i  ' + outlet + ' -p tcp --syn -j REDIRECT --to-ports 9040')
os.system('sudo sh -c "iptables-save > /etc/iptables.ipv4.nat"')

print bcolors.GREEN + "\n[+]. Iptables are Reconfigured" + bcolors.ENDC

print bcolors.WARNING + "\n[!]. Enabling Tor and Hostapd to run at boot" + bcolors.ENDC
