...
print bcolors.WARNING + "\nThis Configuration Will turn your Raspberry-Pi into a Ethernet to VPN Router" + bcolors.ENDC
...
os.system('sudo iptables -A FORWARD -i eth0 -o  ' + outlet + ' -m state --state RELATED,ESTABLISHED -j ACCEPT')
os.system('sudo iptables -A FORWARD -i  ' + outlet + ' -o eth0 -j ACCEPT')
...
cont = raw_input("\n[!]...Press 'Return' to Setup VPN Connection: ")
