...
print bcolors.WARNING + "\nThis Configuration Will turn your Raspberry-Pi into a WiFi Repeater" + bcolors.ENDC
...
os.system('sudo iptables -A FORWARD -i  ' + inlet + ' -o  ' + outlet + ' -m state --state RELATED,ESTABLISHED -j ACCEPT')
os.system('sudo iptables -A FORWARD -i  ' + inlet + ' -o  ' + outlet + ' -j ACCEPT')
